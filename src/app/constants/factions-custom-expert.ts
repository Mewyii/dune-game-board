...
export const factionsCustomExpert: Faction[] = [
    ...
    actionFields: [
      {
        ...
        rewards: [{ type: 'shipping', amount: 2 }, { type: 'shipping', amount: 2 }, { type: 'battle-insert' }],
  ...
  },
  {
    ...
    actionFields: [
      ...
      },
      {
        ...
        actionType: 'landsraad',
        rewards: [{ type: 'buildup' }, { type: 'tech' }],
  ...
  },
  {
    ...
    actionFields: [
      ...
      {
        title: { de: 'unterstützung', en: 'support' },
        actionType: 'spice',
        rewards: [{ type: 'shipping' }, { type: 'shipping' }],
