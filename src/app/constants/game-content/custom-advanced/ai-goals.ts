  ...
  'collect-water': {
    ...
    desireModifier: (player, gameState, goals, virtualResources) => {
      ...
      if (
        ...
        const goalDesire = getDesire(goals['collect-spice'], player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (
        ...
        const goalDesire = getDesire(goals['draw-cards'], player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (!goals['troops'].goalIsReachable(player, gameState, goals, virtualResources)) {
        const goalDesire = getDesire(goals['troops'], player, gameState, virtualResources, aiGoalsCustomAdvanced);
  ...
  'collect-spice': {
    ...
    desireModifier: (player, gameState, goals, virtualResources) => {
      ...
      if (
        ...
        const goalDesire = getDesire(goals['collect-solari'], player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (spice < 4) {
        const goalDesire = getDesire(goals.intrigues, player, gameState, virtualResources, aiGoalsCustomAdvanced);
  ...
  'collect-solari': {
    ...
    desireModifier: (player, gameState, goals, virtualResources) => {
      ...
      if (
        ...
        const goalDesire = getDesire(goals.swordmaster, player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (
        ...
        const goalDesire = getDesire(goals['high-council'], player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (
        ...
        const goalDesire = getDesire(goals.dreadnought, player, gameState, virtualResources, aiGoalsCustomAdvanced);
      ...
      if (!gameState.isFinale && !goals.tech.goalIsReachable(player, gameState, goals, virtualResources)) {
        const goalDesire = getDesire(goals.tech, player, gameState, virtualResources, aiGoalsCustomAdvanced);
