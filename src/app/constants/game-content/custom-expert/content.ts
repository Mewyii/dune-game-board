...
export const gameContentCustomExpert: GameContent = {
  ...
  victoryPointBoni: [
    ...
    { score: 4, reward: { type: 'persuasion', amount: 1 } },
    // { score: 7, reward: { type: 'solari' } },
    // { score: 8, reward: { type: 'troop' } },
    { score: 6, reward: { type: 'persuasion', amount: 1 } },
    // { score: 10, reward: { type: 'solari' } },
    // { score: 11, reward: { type: 'troop' } },
    { score: 8, reward: { type: 'persuasion', amount: 1 } },
    { score: 10, reward: { type: 'persuasion', amount: 1 } },
    { score: 12, reward: { type: 'persuasion', amount: 1 } },
