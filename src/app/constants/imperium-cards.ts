...
export const imperiumCards: ImperiumCard[] = [
  ...
  },
  {
    ...
    customRevealEffect: {
      en: '',
      de: '{resource:loose-troop}{resource:loose-troop}{resource:loose-troop}{resource:faction-influence-down-guild}{resource:faction-influence-down-emperor}{resource:helper-arrow-right}{resource:victory-point}{resource:victory-point}<br>Entsorge diese Karte.',
      fontSize: 'medium',
    },
  },
  {
