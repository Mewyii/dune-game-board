...
export const locationsCustom: DuneLocation[] = [
  {
    ...
    actionField: {
      ...
      actionType: 'town',
      rewards: [{ type: 'card-draw' }, { type: 'troops' }, { type: 'troop-insert' }],
  ...
  },
  {
    ...
    actionField: {
      ...
      rewards: [{ type: 'card-draw', amount: 2 }, { type: 'card-draw-or-destroy' }, { type: 'troop-insert' }],
  ...
  },
  {
    ...
    actionField: {
      ...
      actionType: 'town',
      rewards: [{ type: 'water' }, { type: 'troops' }, { type: 'troop-insert' }],
  ...
  },
  {
    ...
    actionField: {
      ...
      actionType: 'spice',
      rewards: [{ type: 'spice' }, { type: 'extra-spice' }, { type: 'troop-insert' }],
      pathToImage: 'assets/images/action-backgrounds/sandcrawler.png',
      isBattlefield: true,
    },
    ownerReward: { type: 'conviction', amount: 1 },
  },
  {
    color: 'rgb(196, 172, 139)',
    position: {
    ...
    actionField: {
      ...
      actionType: 'spice',
      costs: [{ type: 'water' }],
      rewards: [{ type: 'spice', amount: 2 }, { type: 'extra-spice' }, { type: 'troop-insert' }],
  ...
  },
  {
    ...
    actionField: {
      ...
      rewards: [{ type: 'spice', amount: 3 }, { type: 'extra-spice' }, { type: 'troop-insert' }],
  ...
  //     title: "tuek's sietch",
  //     actionType: 'town',
  //     rewards: [{ type: 'water' }, { type: 'currency', amount: 1 }, { type: 'troop-insert' }],
  //     pathToImage: 'assets/images/action-backgrounds/desert_2.png',
  //     isBattlefield: true,
  //   },
  // },
