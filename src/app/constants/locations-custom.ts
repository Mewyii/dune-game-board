...
export const locationsCustom: DuneLocation[] = [
  ...
  },
  {
    ...
    actionField: {
      ...
      actionType: 'town',
      rewards: [{ type: 'foldspace' }, { type: 'troops' }, { type: 'battle-insert' }],
  ...
  },
  {
    ...
    actionField: {
      ...
      rewards: [{ type: 'card-draw', amount: 2 }, { type: 'card-draw-or-destroy' }, { type: 'battle-insert' }],
  ...
  //     title: "tuek's sietch",
  //     actionType: 'town',
  //     rewards: [{ type: 'water' }, { type: 'currency', amount: 1 }, { type: 'battle-insert' }],
  //     pathToImage: 'assets/images/action-backgrounds/desert_2.png',
  //     isBattlefield: true,
  //   },
  // },
