...
export const leaders: Leader[] = [
  {
    ...
    signetDescription:
      'Draw an intrigue face down. You may trash it at any time to put 1 troop from your storage into combat.',
    type: 'new',
  ...
  },
  {
    ...
    signetDescription: 'Accessing an agent space costs 1 less water.',
    type: 'new',
  ...
  },
  {
    ...
    passiveDescription:
      'Draw 1 additional card at the start of each round. You cannot trash your signet ring. Every time you reveal it, you lose 1 victory point.',
    signetName: 'ego-Memories',
    signetDescription: 'Discard 1 cards. Trash 1 card.',
    type: 'new',
  ...
  },
  {
    ...
    signetDescription:
      'Discard 1 card. If you do, at your reveal turn, either add 3 combat power or draw 1 card and trash 1 card.',
    type: 'new',
