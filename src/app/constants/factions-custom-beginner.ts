    ...
    actionFields: [
      {
        ...
        rewards: [{ type: 'water' }, { type: 'water' }, { type: 'troops', amount: 5 }, { type: 'battle-insert' }],
    ...
    actionFields: [
      {
        ...
        rewards: [{ type: 'intrigue' }, { type: 'troops', amount: 2 }, { type: 'currency', amount: 5 }],
    ...
    actionFields: [
      ...
      },
      {
        ...
        rewards: [
          ...
          { type: 'helper-arrow-down', iconHeight: 30 },
          { type: 'helper-arrow-down', iconHeight: 30 },
          { type: 'troops', amount: 3 },
          { type: 'troops', amount: 4 },
          { type: 'troops', amount: 5 },
          { type: 'troops', amount: 6 },
        ],
