export const enLocale = {
  ...
  commonEffectConditionEnemiesFieldType: 'Opponents on {0} board spaces',
  ...
  commonEffectRewardCardTrashFromHand: 'Trash {0} of your cards from your hand.',
  commonEffectRewardCardTrashInPlay: 'Trash {0} of your cards in play.',
  commonEffectEachOpponent: 'Each opponent:',
  commonEffectTurnPass: 'and pass your turn',
  commonEffectCardChoice: 'Choose Card',
  commonEffectCardAcquire: 'Acquire Card',
  commonEffectCardDiscard: 'Discard Card',
  commonEffectCardTrash: 'Trash Card',
  commonEffectTechTileTrash: 'Trash Tech Tile',
  commonEffectIntrigueTrash: 'Trash Intrigue',
  commonEffectFactionInfluenceIncrease: 'Increase Influence',
  commonEffectFactionInfluenceDecrease: 'Decrease Influence',
  commonEffectConflictChoice: 'Pick Conflict',
  commonEffectLocationChoice: 'Pick Location',
  commonEffectCombatUnitChoice: 'Pick Units',
