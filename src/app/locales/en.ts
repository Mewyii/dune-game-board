export const enLocale = {
  ...
  commonEffectConditionAgentsOnBoardSpaces: 'For each of your {resource:agent} on board spaces',
  commonEffectConditionDreadnoughtAmount: 'For each of your {resource:dreadnought}',
