...
export const deLocale: Locale = {
  ...
  commonEffectConditionAgentsOnBoardSpaces: 'Für jeden deiner {resource:agent} auf Feldern',
  commonEffectConditionDreadnoughtAmount: 'Für jedes deiner {resource:dreadnought}',
