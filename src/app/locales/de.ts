...
export const deLocale: Locale = {
  ...
  commonEffectConditionEnemiesFieldType: 'Jeder Gegner auf {0}-Feldern',
  ...
  commonEffectMultiplierDreadnoughtInGarrisonAmount: 'Für jedes {resource:dreadnought} in deiner Garnison',
  ...
  commonEffectRewardDreadnoughtInsert: 'Setze bis zu {0} deiner {resource:dreadnought} ein.',
  commonEffectRewardDreadnoughtInsertOrRetreat: 'Setze bis zu {0} deiner {resource:dreadnought} ein oder ziehe sie zurück.',
  commonEffectRewardDreadnoughtRetreat: 'Ziehe {0} {resource:dreadnought} zurück',
  commonEffectRewardCardReturnToHand: 'Nimm bis zu {0} deiner Karten im Spiel zurück auf deine Hand.',
  commonEffectRewardCardTrashFromHand: 'Entsorge {0} deiner Karten von deiner Hand.',
  commonEffectRewardCardTrashInPlay: 'Entsorge {0} deiner Karten im Spiel.',
  ...
  commonEffectTurnPass: 'und passe deinen Zug',
  commonEffectCardChoice: 'Karte Wählen',
  commonEffectCardAcquire: 'Karte Erwerben',
  commonEffectCardDiscard: 'Karte Abwerfen',
  commonEffectCardTrash: 'Karte entsorgen',
  commonEffectTechTileTrash: 'Tech-Plättchen Entsorgen',
  commonEffectIntrigueTrash: 'Intrige Entsorgen',
  commonEffectFactionInfluenceIncrease: 'Einfluss erhöhen',
  commonEffectFactionInfluenceDecrease: 'Einfluss verringern',
  commonEffectConflictChoice: 'Schlacht auswählen',
  commonEffectLocationChoice: 'Ort auswählen',
  commonEffectCombatUnitChoice: 'Einheiten auswählen',
  ...
  playerboardWarningNeedToPassTurn: 'Du musst deinen Zug passen',
